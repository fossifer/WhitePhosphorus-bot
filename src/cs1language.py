...
sub_dict = {
    ...
    r'德[语語文]|Germany?|Deutsch': 'de',
    r'希腊[语文]|希臘[語文]|Greek': 'el',
    r'英[语語文]|English|en-UK': 'en',
    r'西班牙[语語文]|Spanish|español': 'es',
    r'爱沙尼亚[语文]|愛沙尼亞[語文]|Estonian': 'et',
    r'波斯[语語文]|Persian': 'fa',
    r'芬兰[语文]|芬蘭[語文]|Finnish': 'fi',
    r'法[语語文]|French|Français|fr-FR': 'fr',
    ...
    r'[汉漢][语語]|Chinese': 'zh',
    r'中文\s*[（(]?(简体?|簡體?)[）)]?|(简体|簡體)(中文|汉语|漢語)|zh-cmn-Hans|zh[-_]CN': 'zh-hans',
    r'中文\s*[（(]?[正繁][体體]?[）)]?|[正繁][体體](中文|汉语|漢語)|zh-cmn-Hant|zh[-_]TW': 'zh-hant',
    r'(\[\[)?粵[语語](\]\])?': 'zh-yue',
}
